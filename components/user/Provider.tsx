...
function UserProvider({ user }: {
    ...
    return (<>
      <script id={USER_ID} type="application/json" dangerouslySetInnerHTML={{ __html: JSON.stringify(user) }}/>
      <script type="module" dangerouslySetInnerHTML={{ __html: useScript(onLoad, USER_ID) }}/>
    </>);
}
